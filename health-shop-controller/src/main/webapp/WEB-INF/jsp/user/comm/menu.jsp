<%@ page language="java"  pageEncoding="UTF-8"%>
	<div class="col-sm-3 pl-30 pr-20">
            <div class="clear bg-white pd-40-10-ipad">
                ...
                <p class="col-757575 f-20-16-ipad line-h-25 mt-40 mb-20 cur-p hovecol-309DE2 col-active user-munu user-order">
                ...
                <p class="col-757575 f-20-16-ipad line-h-25 mt-20 mb-20 cur-p hovecol-309DE2 user-munu user-address">
                    收货地址
                </p>
