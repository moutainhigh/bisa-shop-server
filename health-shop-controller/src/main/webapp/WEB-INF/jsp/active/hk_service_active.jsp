                ...
                <div class="col-sm-12 pl-20 pr-20 bg-white">
                    ...
                    <div class="col-sm-12 clear bor bor-t bor-col-e0e0e0">
                        <div class="claer col-sm-8 pd-30-10-ipad">
                            ...
                            <form class="servicact-validate clear" action="<%=request.getContextPath()%>/a/active_commit" method="get">
                                <div class="clear full-w">
                                    <div class="clear col-sm-6 plr-15-5-ipad">
                                        <input type="text" class="form-control mt-20 radius-0 activate-code" name="appcode" placeholder="请输入您的激活码">
